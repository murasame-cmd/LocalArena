...
final class DurakGame {
    ...
    boolean take(int p){if(finished||p!=defender||attack.isEmpty())return false;for(int c:attack)hand[p].add(c);attack.clear();defense.clear();refill(attacker);refill(defender);checkFinish();return true;}
